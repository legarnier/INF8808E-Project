...
viz1_title = "Current protocol latency in ms"
...
def update_gauges(site_qc_clicks, site_on_clicks, site_man_clicks, radio_type_value, n_intervals):
    ...
    if button_id == "button-site-qc":
        selected_data = vis1.dict_data_site['Quebec'][radio_type_value]
    elif button_id == "button-site-on":
        selected_data = vis1.dict_data_site['Ontario'][radio_type_value]
    elif button_id == "button-site-man":
        selected_data = vis1.dict_data_site['Manitoba'][radio_type_value]
    else:
        selected_data = vis1.dict_data_site['Quebec'][radio_type_value]
    ...
    gauges = []
    for i, variable in enumerate(vis1.variables):
